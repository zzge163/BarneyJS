    ...
    var IconLayers = L.Control.extend({
        ...
        _createLayerElements: function () {
            ...
            for (var i = 0; i < layers.length; i++) {
                ...
                if (layers[0][i].id === activeLayerId) {
                ...
                layerCell.appendChild(this._createLayerElement(layers[i][0]));
        ...
        _switchMapLayers: function () {
            ...
            if (previousLayer) {
                this._map.removeLayer(previousLayer[0].layer);
                !!previousLayer[1].layer && this._map.removeLayer(previousLayer[1].layer);
            } else {
            ...
            if (activeLayer) {
                this._map.addLayer(activeLayer[0].layer);
                !!activeLayer[1].layer && this._map.addLayer(activeLayer[1].layer);
            }
        },
        options: {
            position: 'topright', // one of expanding directions depends on this
