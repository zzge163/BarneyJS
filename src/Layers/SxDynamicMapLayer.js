EsriLeaflet.Layers.DynamicMapLayer = EsriLeaflet.Layers.RasterLayer.extend({
    ...
    statics: {
        City: {
            urlTemplate: 'http://124.115.170.132:8080/ServiceSystem/services/rest/BouCity_py/{token}/TFServer',
            attributionUrl: ''
        },
        County: {
            urlTemplate: 'http://124.115.170.132:8080/ServiceSystem/services/rest/BouCounty_py/{token}/TFServer',
            attributionUrl: ''
        },
        Town: {
            urlTemplate: 'http://124.115.170.132:8080/ServiceSystem/services/rest/BouCounty_py/{token}/TFServer',
